 ...
 * argument are performed using the {@link java.util.concurrent.fork.ForkJoinPool#commonPool()}
...
public class CompletableFuture<T> implements Future<T>, CompletionStage<T> {
    ...
    static Object encodeRelay(Object r) {
        ...
        return (((r instanceof AltResult) &&
                ...
                new AltResult(new java.util.concurrent.exception.CompletionException(x)) : r);
    }
    ...
    private static final boolean useCommonPool =
        (java.util.concurrent.fork.ForkJoinPool.getCommonPoolParallelism() > 1);
    ...
    static Executor screenExecutor(Executor e) {
        if (!useCommonPool && e == java.util.concurrent.fork.ForkJoinPool.commonPool())
            return asyncPool;
    ...
    @SuppressWarnings("serial")
    static final class AsyncSupply<T> extends java.util.concurrent.fork.ForkJoinTask<Void>
            implements Runnable, AsynchronousCompletionTask {
    ...
    @SuppressWarnings("serial")
    static final class AsyncRun extends java.util.concurrent.fork.ForkJoinTask<Void>
            implements Runnable, AsynchronousCompletionTask {
    ...
    static final class Signaller extends Completion
        implements java.util.concurrent.fork.ForkJoinPool.ManagedBlocker {
    ...
    private Object waitingGet(boolean interruptible) {
        ...
        while ((r = result) == null) {
            if (spins < 0)
                ...
                try {
                    java.util.concurrent.fork.ForkJoinPool.managedBlock(q);
     ...
     */
    private Object timedGet(long nanos) throws java.util.concurrent.exception.TimeoutException {
        if (Thread.interrupted())
            return null;
        if (nanos <= 0L)
     ...
     * by a task running in the {@link java.util.concurrent.fork.ForkJoinPool#commonPool()} with
    ...
    /**
     * Returns a new CompletableFuture that is asynchronously completed
     * by a task running in the {@link java.util.concurrent.fork.ForkJoinPool#commonPool()} after
     ...
     * @throws InterruptedException if the current thread was interrupted
     * while waiting
     * @throws java.util.concurrent.exception.TimeoutException if the wait timed out
     */
    ...
    public boolean isCancelled() {
        ...
        return ((r = result) instanceof AltResult) &&
            (((AltResult)r).ex instanceof java.util.concurrent.exception.CancellationException);
    }
