 ...
 * }}</pre>
 *
 * {@link java.util.concurrent.FutureTask}类是{@code Future}的一个实现，它实现了{@code Runnable}，因此可以由{@code Executor}执行。
...
public interface Future<V> {
     ...
     *
     * @return 计算的结果
     * @throws java.util.concurrent.exception.CancellationException 如果计算被取消
     * @throws java.util.concurrent.exception.ExecutionException 如果计算抛出异常
     ...
     * @throws java.util.concurrent.exception.ExecutionException 如果计算抛出异常
     * @throws InterruptedException 如果当前线程在等待时被中断
     * @throws java.util.concurrent.exception.TimeoutException 如果等待超时
     */
