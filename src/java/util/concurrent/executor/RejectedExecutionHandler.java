...
/**
 * 拒绝策略：不能由{@link java.util.concurrent.executor.ThreadPoolExecutor}执行的任务的处理程序。
 *
 * @since 1.5
 * @author Doug Lea
 */
public interface RejectedExecutionHandler {
    ...
    /**
     * 当{@link java.util.concurrent.executor.ThreadPoolExecutor#execute execute}不能接受任务时，{@link ThreadPoolExecutor}可以调用该方法。
     ...
     */
    void rejectedExecution(Runnable r, java.util.concurrent.executor.ThreadPoolExecutor executor);
}
